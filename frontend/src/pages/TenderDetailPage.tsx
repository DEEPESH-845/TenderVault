          ...
          <div className="flex items-center gap-3">
            ...
            {userInfo?.role === 'tv-admin' && (
              <button
                ...
                className="text-xs font-medium text-red-600 bg-red-50 hover:bg-red-100 px-3 py-1 rounded-full border border-red-200 transition-colors flex items-center gap-1"
